...
function initThemeSwitch() {
    ...
    const updateLogos = () => {
        ...
        if (lightMode) {
            ...
            // siteLogos.attr("src", "{{ asset('assets/image/marko-logo-dark.png') }}");
            siteLogos.attr("src", siteLogoDark); // for dark mode
            ...
            // siteLogos.attr("src", "{{ asset('assets/image/marko-logo.png') }}");
            siteLogos.attr("src", siteLogo);     // for light mode
