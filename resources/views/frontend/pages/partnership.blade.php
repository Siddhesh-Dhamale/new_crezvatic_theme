                            ...
                            <div class="row row-cols-md-4 row-cols-1 g-0">
                                <div class="col partnership-container">
                                    <div class="partnership-item">
                                        <a href="#">
                                            <img src="{{ asset('assets//image/client-2.png')}}" alt="Partner Logo" class="partner-logo img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col partnership-container">
                                    <div class="partnership-item">
                                        <a href="#">
                                            <img src="{{ asset('assets//image/client-1.png')}}" alt="Partner Logo" class="partner-logo img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col partnership-container">
                                    <div class="partnership-item">
                                        <a href="#">
                                            <img src="{{ asset('assets//image/client-3.png')}}" alt="Partner Logo" class="partner-logo img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col partnership-container">
                                    <div class="partnership-item">
                                        <a href="#">
                                            <img src="{{ asset('assets//image/client-5.png')}}" alt="Partner Logo" class="partner-logo img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col partnership-container">
                                    <div class="partnership-item">
                                        <a href="#">
                                            <img src="{{ asset('assets//image/client-4.png')}}" alt="Partner Logo" class="partner-logo img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col partnership-container">
                                    <div class="partnership-item">
                                        <a href="#">
                                            <img src="{{ asset('assets//image/client-6.png')}}" alt="Partner Logo" class="partner-logo img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col partnership-container">
                                    <div class="partnership-item">
                                        <a href="#">
                                            <img src="{{ asset('assets//image/client-7.png')}}" alt="Partner Logo" class="partner-logo img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col partnership-container">
                                    <div class="partnership-item">
                                        <a href="#">
                                            <img src="{{ asset('assets//image/client-8.png')}}" alt="Partner Logo" class="partner-logo img-fluid">
                                        </a>
                                    </div>
                                </div>
                            </div>
